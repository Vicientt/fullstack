...
const App = () => {
  ...
  // Effect just display add anounnce in 3 second 
  useEffect(() => {
  ...
  // Effect display change phone number announce in 3 second
  useEffect(() => {
    const timer = setTimeout(() => {
      setSuccessMessage('')
    },3000)
  ...
  // Effect display error message anonounce in 3 second
  useEffect(() => {
    const timer = setTimeout(() => {
      setErrorMessage('')
    },3000)
  ...
  const handleSubmit_addperson = (event) => {
    ...
    axios
      ...
      .then(response => {
          ...
          setNewName('')
          setNewNumber('')
          setAnnounceName(newPerson.name)
        }
      )
  }
